...
already ~80% pinned by the Merlin client and by `spec.md` §2241–2263 in the
Merlin repo (`~/Documents/localProject/merlin/spec.md`).

- Working directory: `~/Documents/localProject/merlin/plugins/merlin-kicad-mcp`
- Task sheets: `tasks/` — decomposition in `tasks/ROADMAP.md`
...
merlin-kicad-mcp/
  ...
  tasks/                     — task sheets + ROADMAP.md
  constitution.md  README.md  .gitignore
```
...
Each task file carries its own Context header, the full task, a Verify step, and an
explicit `git add` + `git commit`. See `tasks/ROADMAP.md` for the full decomposition.
