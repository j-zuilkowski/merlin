...
1. **Ask for project metadata** (do not assume defaults):
   ...
   - Doc-set choice: `full` (all seven docs) or `minimal` (README + constitution.md only)
...
7. **Write `tasks/` directory** with `task-00-scaffold.md` documenting the initial state.
