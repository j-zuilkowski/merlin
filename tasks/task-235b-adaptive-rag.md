...
Task 235a complete: failing tests for budget-aware RAG selection and the text estimator.
...
Expected: **BUILD SUCCEEDED** and all task 235a tests pass.
...
git commit -m "Task 235b — Adaptive RAG (budget-derived chunk selection)"
```

## PASTE-LIST update

Append task 235a/235b under the "Budget-Aware Execution (v2.1.0)" section.
