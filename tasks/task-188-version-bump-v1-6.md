...
**Find:** `MARKETING_VERSION: "1.5.0"`
**Replace:** `MARKETING_VERSION: "1.6.0"`

**Find:** `CURRENT_PROJECT_VERSION: 4`
**Replace:** `CURRENT_PROJECT_VERSION: 5`

---

## Edit: constitution.md

**Find:** `**Current version: 1.5.0** (build 4, tag \`v1.5.0\`)`
**Replace:** `**Current version: 1.6.0** (build 5, tag \`v1.6.0\`)`
...
```
Expected: BUILD SUCCEEDED; version string `1.6.0`.
...
```bash
cd ~/Documents/localProject/merlin
git add project.yml constitution.md Merlin.xcodeproj/project.pbxproj
...
echo "DMG: $(du -sh ~/Documents/localProject/merlin/dist/Merlin-2026-05-08-v1.6.0.dmg)"
```
