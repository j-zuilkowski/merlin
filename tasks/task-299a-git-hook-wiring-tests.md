...
## Commit
```
git add MerlinTests/Unit/GitHookWiringTests.swift tasks/task-299a-git-hook-wiring-tests.md
git commit -m "Task 299a — Git hook wiring tests (failing)"
```
