# Task 35b — Inline Diff Commenting Implementation
...
Task 35a complete: failing DiffCommentTests in place.
...
git add Merlin/Engine/DiffComment.swift \
        ...
        project.yml
git commit -m "Task 35b — inline diff commenting + submitDiffComments"
```
