...
## 2. Edit: phases/diag-01b-telemetry-emitter.md
...
## Commit
```
git add Merlin/Telemetry/TelemetryEmitter.swift phases/diag-01b-telemetry-emitter.md phases/phase-322-remove-dead-telemetry-setters.md
