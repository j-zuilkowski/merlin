...
Discipline today catches *phase drift* — spec/doc/code pulling apart. It is blind to
...
no scheme builds, or that only non-gating schemes build. It is a peer of `PhaseScanner`,
...
## Commit
```
git add MerlinTests/Unit/TargetGateScannerTests.swift phases/phase-307a-target-gate-scanner-tests.md
