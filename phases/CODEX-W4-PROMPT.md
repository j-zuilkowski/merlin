...
- The phase files in phases/ are self-contained — each has the exact file contents
...
PHASE 320a — Read phases/phase-320a-worker-diff-actions-tests.md
...
Commit: git add MerlinTests/Unit/WorkerDiffViewActionTests.swift phases/phase-320a-worker-diff-actions-tests.md
        git commit -m "Phase 320a — WorkerDiffViewActionTests (failing)"

PHASE 320b — Read phases/phase-320b-worker-diff-actions.md
...
Expected: both WorkerDiffViewActionTests pass; BUILD SUCCEEDED on both schemes,
  zero warnings.
Commit: git add Merlin/UI/Sidebar/WorkerDiffView.swift phases/phase-320b-worker-diff-actions.md
        git commit -m "Phase 320b — Wire WorkerDiffView reject-all / accept-and-merge"

PHASE 321a — Read phases/phase-321a-doc-reference-comment-tests.md
...
Commit: git add MerlinTests/Unit/DocReferenceGraphCommentTests.swift phases/phase-321a-doc-reference-comment-tests.md
        git commit -m "Phase 321a — DocReferenceGraphCommentTests (failing)"

PHASE 321b — Read phases/phase-321b-doc-reference-comment.md
...
Expected: every test in all seven DocReference* classes passes; BUILD SUCCEEDED,
  zero warnings.
Commit: git add Merlin/Discipline/DocReferenceGraph.swift MerlinTests/Unit/DocReferenceDanglingTests.swift phases/phase-321b-doc-reference-comment.md
