...
2. **Read existing documentation** (`CLAUDE.md`, `AGENTS.md`, `architecture.md`):
...
- Phase drift: mostly green (230+ phases, well-maintained)
- WHY-comment violations: present in engine files (Task.sleep, try?)
- Prose readability: architecture.md targets grade 11; user-manual.md targets grade 9
...
- Never delete or overwrite existing content in `CLAUDE.md`.
...
```bash
git add phases/phase-263b-project-adopt-skill.md
