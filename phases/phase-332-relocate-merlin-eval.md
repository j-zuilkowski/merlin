...
## Step 3 — Sync the phase-326 doc
`phases/phase-326-eval-capability-harness.md` contains the full `EvalSupport.swift`
listing. Apply the **same** Edits A–D to that listing inside the phase doc, and append a
`## Fixes` section:
```
## Fixes
...
git add merlin-eval .gitignore MerlinE2ETests/EvalSupport.swift \
        ...
        phases/phase-332-relocate-merlin-eval.md
...
- Follow-up (non-blocking): `phases/PASTE-LIST.md` and any loose W4/W5 prompt artifacts
