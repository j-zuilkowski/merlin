...
This phase ships v2.1.0 — Budget-Aware Execution. Follow `architecture.md` § Versioning Policy
...
- **Do not modify `architecture.md`.** The "V2.1 — Budget-Aware Execution" section was written
...
git add phases/phase-240b-v2-1-release.md \
    project.yml \
    CLAUDE.md \
    RELEASE-v2.1.0.md \
