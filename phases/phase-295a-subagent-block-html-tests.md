# Phase 295a — Subagent Block HTML Tests (failing)

## Context
Swift 5.10, macOS 14+. Working dir: ~/Documents/localProject/merlin.
Unit B2 of the wiring plan. Phase 294 complete (RAG sources HTML).
...
## Commit
```
git add MerlinTests/Unit/SubagentBlockHTMLTests.swift phases/phase-295a-subagent-block-html-tests.md
git commit -m "Phase 295a — Subagent block HTML tests (failing)"
```
