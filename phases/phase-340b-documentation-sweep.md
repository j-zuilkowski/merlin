...
- `phases/SURFACE-INVENTORY.md`: update only if this living checklist is still
  treated as current.

Do not rewrite historical release notes, old phase files, or dated handoff
...
rg -n "ProviderHUD|top-of-chat|top of the chat|11 defined providers|five local providers|other five" \
    README.md FEATURES.md Merlin/Docs docs/local-provider-configs merlin-eval phases/SURFACE-INVENTORY.md
```
...
git add README.md \
        ...
        phases/phase-340b-documentation-sweep.md
