...
This phase ships **v2.2.4** — phases 283–288 together. Follows `architecture.md`
...
- **Version banners — every doc that carries one** (2.2.3 → 2.2.4, build 20 → 21):
    - `CLAUDE.md`: `**Current version: 2.2.4** (build 21, tag v2.2.4)`.
...
```bash
grep -rnE "2\.2\.3|build 20" README.md CLAUDE.md Requirements.md \
...
```bash
git add phases/phase-289-v2-2-4-release.md \
    project.yml \
