...
- Keep historical phase file references historical; do not rewrite old phase
  descriptions.
...
- Replace planned file-layout/settings text with shipped surface:
  ...
  - `AppSettings.cagPinClaudeMD`
  - `AppSettings.cagPinnedPhaseDocs`
...
rg -n "v2\\.3 planned|CAG.*planned|Status: not implemented|phase work is deferred" \
    architecture.md FEATURES.md Merlin/Docs/UserGuide.md Merlin/Docs/DeveloperManual.md
```
...
git add architecture.md \
        ...
        phases/phase-343b-cag-docs-status.md
