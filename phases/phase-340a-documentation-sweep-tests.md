...
Historical release notes, old phase files, and dated handoff snapshots may
...
- Exclude: `RELEASE-*`, dated handoffs, old phase files except
  `phases/SURFACE-INVENTORY.md`, and historical aggregate `phases/ALL-PHASES.md`.
...
git add MerlinTests/Unit/DocumentationSweepTests.swift \
        phases/phase-340a-documentation-sweep-tests.md
