# Phase 273b — v2.2.1 Release

## Context
Swift 5.10, macOS 14+, SwiftUI + async/await. Non-sandboxed. No third-party packages.
SWIFT_STRICT_CONCURRENCY=complete. Zero warnings, zero errors required.
Working dir: ~/Documents/localProject/merlin
Phase 273a complete: failing tests asserting v2.2.1 version and `RELEASE-v2.2.1.md`.

This phase ships **v2.2.1 — Project Discipline remediation**. It bumps the project
...
fixes the correctness bugs found in code review (phases 266–272).
...
"coordinates five scanners". After phase 270b the engine genuinely runs all five — the
phase-scanner, manual-coverage scanner, doc-reference graph, why-comment scanner, and
...
Expected: **BUILD SUCCEEDED** and all phase 273a tests pass (version 2.2.1, build 18,
release notes present). No prior phase regresses.

## Commit

```bash
git add phases/phase-273b-v2-2-1-release.md \
    project.yml \
    CLAUDE.md \
    RELEASE-v2.2.1.md \
    Merlin/Docs/DeveloperManual.md
git commit -m "Phase 273b — Bump version to 2.2.1 (build 18)"
```
...
Do NOT push and do NOT create the GitHub release as part of this phase. Pushing the tag
...
release (phase 265b) was handled. The phase ends at the local commit + local tag.
