...
Phase 324b complete: PhaseScanner symbol-matching accuracy landed.

The W5 surface census (`merlin-eval/SURFACE-CENSUS.md` §1.2) found **12 interactive
controls with no `AccessibilityID`** — the phase-306 pass missed them. XCUITest (eval
...
## Commit
```
git add MerlinTests/Unit/AccessibilityIDCoverageTests.swift phases/phase-325a-accessibility-id-gap-tests.md
