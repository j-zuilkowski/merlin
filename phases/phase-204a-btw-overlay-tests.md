...
TDD coverage:
  File 1 — BtwSessionTests: ask() sends to provider, does NOT touch ContextManager, streams answer

---

## Write to: MerlinTests/Unit/BtwSessionTests.swift
...
Expected: **BUILD FAILED** — `BtwSession`, `MockProvider(response:delay:)` do not exist.
