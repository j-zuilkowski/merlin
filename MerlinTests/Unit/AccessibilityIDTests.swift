...
final class AccessibilityIDTests: XCTestCase {
    ...
    private let required: [String] = [
        ...
        AccessibilityID.chatAttachmentButton,
        AccessibilityID.chatVoiceButton,
        AccessibilityID.sideChatInput,
        AccessibilityID.sideChatSendButton,
        AccessibilityID.sideChatCancelButton,
        AccessibilityID.sideChatAttachmentButton,
        AccessibilityID.sideChatVoiceButton,
