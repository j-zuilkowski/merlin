...
Gates #1-#13 are passed. Gate #13 recorded the final safety check log with
version `2.4.0`, release evidence presence, screenshot asset count, clean
starting status, and no orphan Merlin/helper processes. The immediate blocker
is gate #14: create tag `v2.4.0`.
