...
Read CLAUDE.md and architecture.md first (search for "## V2.2 — Project Discipline Subsystem").
...
- Per-phase loop: cat the phase file → implement → verify (expected outcome is in the file)
  → commit → next phase.
...
cat phases/phase-241a-adapter-registry-tests.md
```
